class AltrUser {
  ...
  final List<String> joinedWorkspaces;
  ...
  factory AltrUser.fromMap(Map<String, dynamic> map, {required String activeWorkspaceId}) => AltrUser(
    userId: map['user_id'] ?? '',
    userName: map['user_name'] ?? '',
    displayName: map['display_name'] ?? '',
    photoUrl: map['photo_url'] ?? '',
    emailId: map['email_id'] ?? '',
    joinedWorkspaces: List<String>.from(map['joined_workspaces'] ?? []),
