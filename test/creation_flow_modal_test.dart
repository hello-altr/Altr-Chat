...
void main() {
  ...
  testWidgets('CreationFlowModal Mobile View - Full Screen Scaffold', (WidgetTester tester) async {
    ...
    // Verify it is shown directly in a mobile route Page (MaterialPageRoute scaffold)
    // No dialog/overlay modal should be instantiated since it flattens to full scaffold
